    ...
    // if (sparse == 1){
    {
        ...
        if (kernel == 0){
            ...
            //-------------edit here to change the output file-----------------------------
                ...
                if(vec_length == 8){
                    if(reorder) line = "_rospmm_8_v1.csv";
                    else line = "_rospmm_8_v0.csv";
                }
                
                else if(vec_length == 16){
                    if(reorder) line = "_rospmm_16_v1.csv";
                    else line = "_rospmm_16_v0.csv";
                }
...
int main(int argc, char **argv){
    ...
    std::string arch(argv[10]);
    {
        ...
        if(reorder == 1){
            if(vec_length == 8){
                benchmark = "../benchmark/dataset-v8/";
            }
            else if(vec_length == 16){
                benchmark = "../benchmark/dataset-v16/";
            }
            else{
