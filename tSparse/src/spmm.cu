...
int main(int argc, char ** argv)
{
    ...
    else if (argc == 2)
    {
        ...
        B = A;
        // B = cusp::coo_matrix<IndexType,ValueType,cusp::device_memory>(A.num_cols, 512, A.num_cols * 512);
        // B = cusp::csr_matrix<IndexType,ValueType,cusp::device_memory>(A.num_cols, 512, A.num_cols * 512);
